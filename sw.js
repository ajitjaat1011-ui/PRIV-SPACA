 ...
 */
const SW_VERSION = 'priv-spaca-v73-call-icon-fix';
const STATIC_CACHE = 'priv-spaca-static-v73-call-icon-fix';
const RUNTIME_CACHE = 'priv-spaca-runtime-v73-call-icon-fix';
