 ...
 */
const SW_VERSION = 'priv-spaca-v67-self-heal';
const STATIC_CACHE = 'priv-spaca-static-v67-self-heal';
const RUNTIME_CACHE = 'priv-spaca-runtime-v67-self-heal';

const APP_SHELL = [
  '/',
  '/index.html',
  '/style.css?v=67-self-heal',
  '/app.js?v=67-self-heal',
  '/manifest.json',
  '/favicon.ico',
  '/favicon-16x16.png',
  '/favicon-32x32.png',
