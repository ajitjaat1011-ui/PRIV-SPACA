 ...
 */
const SW_VERSION = 'priv-spaca-v1.9';
const STATIC_CACHE = 'priv-spaca-static-v1.9';
const RUNTIME_CACHE = 'priv-spaca-runtime-v1.9';
...
// request (style.min.css?v=19, boot-guard.min.js?v=10, vendor ?v=10,
// auth.react.min.js?v=19 lazy from app.js, heic2any ?v=0.0.4 lazy from
// app.js, app.min.js?v=20 and icons-v2.js?v=12 from index.html). A shell
...
const APP_SHELL = [
  SW_BASE + '/',
  SW_BASE + '/index.html',
  SW_BASE + '/style.min.css?v=19',
  SW_BASE + '/app.min.js?v=20',
  SW_BASE + '/boot-guard.min.js?v=10',
  SW_BASE + '/icons-v2.js?v=12',
  SW_BASE + '/auth.react.min.js?v=19',
