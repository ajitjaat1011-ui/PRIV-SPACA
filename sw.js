 ...
 */
const SW_VERSION = 'priv-spaca-v66-perf-batch';
const STATIC_CACHE = 'priv-spaca-static-v66-perf-batch';
const RUNTIME_CACHE = 'priv-spaca-runtime-v66-perf-batch';

const APP_SHELL = [
  '/',
  '/index.html',
  '/style.css?v=66-perf-batch',
  '/app.js?v=66-perf-batch',
  '/manifest.json',
  '/favicon.ico',
  '/favicon-16x16.png',
  '/favicon-32x32.png',
