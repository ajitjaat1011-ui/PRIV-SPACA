 ...
 */
const SW_VERSION = 'priv-spaca-v1.5';
const STATIC_CACHE = 'priv-spaca-static-v1.5';
const RUNTIME_CACHE = 'priv-spaca-runtime-v1.5';
...
// request (style.min.css?v=15, boot-guard.min.js?v=10, vendor ?v=10,
// auth.react.min.js?v=15 lazy from app.js, heic2any ?v=0.0.4 lazy from
// app.js, app.min.js?v=16 and icons-v2.js?v=12 from index.html). A shell
...
const APP_SHELL = [
  SW_BASE + '/',
  SW_BASE + '/index.html',
  SW_BASE + '/style.min.css?v=15',
  SW_BASE + '/app.min.js?v=16',
  SW_BASE + '/boot-guard.min.js?v=10',
  SW_BASE + '/icons-v2.js?v=12',
  SW_BASE + '/auth.react.min.js?v=15',
