 ...
 */
const SW_VERSION = 'priv-spaca-v72-rtc-fix';
const STATIC_CACHE = 'priv-spaca-static-v72-rtc-fix';
const RUNTIME_CACHE = 'priv-spaca-runtime-v72-rtc-fix';

const APP_SHELL = [
  '/',
  '/index.html',
  '/style.css?v=72-rtc-fix',
  '/app.js?v=72-rtc-fix',
  '/manifest.json',
  '/favicon.ico',
  '/favicon-16x16.png',
