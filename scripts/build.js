...
try {
  ...
  html = html.replace(/style\.css(\?v=[^"']*)?/g, 'style.min.css?v=78-prod');
  html = html.replace(/app\.js(\?v=[^"']*)?/g, 'app.min.js?v=78-prod');
  // Write modified HTML
...
try {
  ...
  sw = sw.replace(/style\.css(\?v=[^']*)?/g, 'style.min.css?v=78-prod');
  sw = sw.replace(/app\.js(\?v=[^']*)?/g, 'app.min.js?v=78-prod');
  sw = sw.replace(/priv-spaca-v\d+-[a-z]+/g, 'priv-spaca-v78-prod');
