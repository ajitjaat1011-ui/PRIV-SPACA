...
try {
  ...
  html = html.replace(/style\.css(\?v=[^"']*)?/g, 'style.min.css?v=90');
  html = html.replace(/app\.js(\?v=[^"']*)?/g, 'app.min.js?v=90');
  // Write modified HTML
...
try {
  ...
  sw = sw.replace(/style\.css(\?v=[^']*)?/g, 'style.min.css?v=90');
  sw = sw.replace(/app\.js(\?v=[^']*)?/g, 'app.min.js?v=90');
