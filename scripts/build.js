...
try {
  ...
  html = html.replace(/style\.css(\?v=[^"']*)?/g, 'style.min.css?v=127');
  html = html.replace(/app\.js(\?v=[^"']*)?/g, 'app.min.js?v=127');
  // Write modified HTML
...
try {
  ...
  sw = sw.replace(/style\.css(\?v=[^']*)?/g, 'style.min.css?v=127');
  sw = sw.replace(/app\.js(\?v=[^']*)?/g, 'app.min.js?v=127');
